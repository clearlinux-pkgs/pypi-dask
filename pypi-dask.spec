...
Version  : 2022.3.0
Release  : 146
URL      : https://files.pythonhosted.org/packages/2a/4a/7651464c72d779d5768aeafce710b24dab44ab4057d25692eb8081e939d7/dask-2022.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/2a/4a/7651464c72d779d5768aeafce710b24dab44ab4057d25692eb8081e939d7/dask-2022.3.0.tar.gz
...
%prep
%setup -q -n dask-2022.3.0
cd %{_builddir}/dask-2022.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647712067
...
cp %{_builddir}/dask-2022.3.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-dask/a13640c0c947476791b93d0878e07dc9cc7caeea
