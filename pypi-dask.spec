...
Version  : 2023.3.1
Release  : 184
URL      : https://files.pythonhosted.org/packages/43/15/8c5df232ad476cc06184eaa0137f4a9313defcbe9d0601fdaa382e00bd9d/dask-2023.3.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/43/15/8c5df232ad476cc06184eaa0137f4a9313defcbe9d0601fdaa382e00bd9d/dask-2023.3.1.tar.gz
...
%prep
%setup -q -n dask-2023.3.1
cd %{_builddir}/dask-2023.3.1
pushd ..
cp -a dask-2023.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678719900
