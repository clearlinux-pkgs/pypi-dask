...
Version  : 2022.7.0
Release  : 158
URL      : https://files.pythonhosted.org/packages/0f/bf/ee24e112ed98d31b33b5a49db948bfd33e92c6795f18b83127d03ae2b71e/dask-2022.7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/0f/bf/ee24e112ed98d31b33b5a49db948bfd33e92c6795f18b83127d03ae2b71e/dask-2022.7.0.tar.gz
...
%prep
%setup -q -n dask-2022.7.0
cd %{_builddir}/dask-2022.7.0
pushd ..
cp -a dask-2022.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657478289
...
cp %{_builddir}/dask-2022.7.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-dask/a13640c0c947476791b93d0878e07dc9cc7caeea
cp %{_builddir}/dask-2022.7.0/dask/array/NUMPY_LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-dask/dc62380a94a8f632cfd8afabbf101a51d6773ac8
