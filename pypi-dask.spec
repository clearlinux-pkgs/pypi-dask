...
Version  : 2022.6.1
Release  : 157
URL      : https://files.pythonhosted.org/packages/dc/b1/7d6dba308524eb73ce59025f7b7fdfa431eab3508aa7668a91f8f9f440cc/dask-2022.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/dc/b1/7d6dba308524eb73ce59025f7b7fdfa431eab3508aa7668a91f8f9f440cc/dask-2022.6.1.tar.gz
...
%prep
%setup -q -n dask-2022.6.1
cd %{_builddir}/dask-2022.6.1
pushd ..
cp -a dask-2022.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656096369
...
cp %{_builddir}/dask-2022.6.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-dask/a13640c0c947476791b93d0878e07dc9cc7caeea
cp %{_builddir}/dask-2022.6.1/dask/array/NUMPY_LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-dask/dc62380a94a8f632cfd8afabbf101a51d6773ac8
