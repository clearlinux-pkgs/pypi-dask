...
Version  : 2022.5.2
Release  : 155
URL      : https://files.pythonhosted.org/packages/0c/7e/540c807f5b9426514623f2740f6333b49ca406d5c7698166f18db5941e3e/dask-2022.5.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/0c/7e/540c807f5b9426514623f2740f6333b49ca406d5c7698166f18db5941e3e/dask-2022.5.2.tar.gz
...
%prep
%setup -q -n dask-2022.5.2
cd %{_builddir}/dask-2022.5.2
pushd ..
cp -a dask-2022.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653611627
...
cp %{_builddir}/dask-2022.5.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-dask/a13640c0c947476791b93d0878e07dc9cc7caeea
cp %{_builddir}/dask-2022.5.2/dask/array/NUMPY_LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-dask/dc62380a94a8f632cfd8afabbf101a51d6773ac8
