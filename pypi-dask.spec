...
Version  : 2024.7.1
Release  : 226
URL      : https://files.pythonhosted.org/packages/bf/eb/87205a2e4d8d2744ea0abbe57ee432bd014220079d37dfb06e5209899fff/dask-2024.7.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/bf/eb/87205a2e4d8d2744ea0abbe57ee432bd014220079d37dfb06e5209899fff/dask-2024.7.1.tar.gz
...
%prep
%setup -q -n dask-2024.7.1
cd %{_builddir}/dask-2024.7.1
pushd ..
cp -a dask-2024.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721662054
