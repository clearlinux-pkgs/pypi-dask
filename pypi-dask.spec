...
%prep
%setup -q -n dask-2022.4.0
cd %{_builddir}/dask-2022.4.0
...
cp %{_builddir}/dask-2022.4.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-dask/a13640c0c947476791b93d0878e07dc9cc7caeea
