...
Source0  : https://files.pythonhosted.org/packages/b8/0a/1011ce75bc1e2da627d481f4bfcaf0eaf3367eb2e432ed908620e0a0fcfa/dask-2024.12.0.tar.gz
...
%prep
%setup -q -n dask-2024.12.0
cd %{_builddir}/dask-2024.12.0
pushd ..
cp -a dask-2024.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733321277
