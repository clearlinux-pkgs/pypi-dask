...
Version  : 2022.8.0
Release  : 160
URL      : https://files.pythonhosted.org/packages/4d/eb/9d7656370ca1a54e525867f20566fc6278b4c2cd77d27f55db262aa63ece/dask-2022.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/4d/eb/9d7656370ca1a54e525867f20566fc6278b4c2cd77d27f55db262aa63ece/dask-2022.8.0.tar.gz
...
%prep
%setup -q -n dask-2022.8.0
cd %{_builddir}/dask-2022.8.0
pushd ..
cp -a dask-2022.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659970826
